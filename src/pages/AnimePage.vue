<template>
  <div class="anime-body body">
    <div class="flex-container">
      <div class="choice-btn-container">
        <button class="choice-btn btn-1">Anime</button>
        <button class="choice-btn btn-2" @click="goToCharacter">
          Character
        </button>
      </div>
      <h1 htmlFor="anime">Enter the name of an anime to get a quote!</h1>
      <div class="input-box">
        <input class="input-box" type="text" id="anime" placeholder="Anime" />
      </div>
